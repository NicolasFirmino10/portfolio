...
export default function Stack() {
    ...
    const categories = [
        ...
        {
            title: dict.apisStack,
            items: content.stack?.apis || [],
        },
        {
                                        ...
                                        <HoverCard key={item.name} openDelay={50} closeDelay={50}>
                                            <HoverCardTrigger asChild>
                                                <div className="group flex items-center gap-3 py-2.5 px-1 shrink-0 cursor-default">
                                                    <div className={cn(
                                                        "transition-all duration-500 ease-out opacity-50 grayscale group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-110 dark:group-hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.45)]",
                                            ...
                                            >
                                                ...
                                                <div className="relative p-3 rounded-xl bg-secondary/50 ring-1 ring-border/50 shadow-inner group-hover:scale-110 transition-transform duration-500">
                                                    <Image src={item.icon} alt={item.name} width={36} height={36} className={cn("drop-shadow-lg", item.invertOnDark && "dark:invert")} unoptimized={item.icon.endsWith('.svg')} />
                                                </div>
