...
const TRACK_1 = [
    "/hero-slider/slide-terminal.webp",
    "/hero-slider/slide-chart.webp",
    "/hero-slider/slide-network.webp",
    "/hero-slider/slide-table.webp",
    "/hero-slider/slide-gradient.webp",
    "/hero-slider/slide-circuit.webp",
] as const;
